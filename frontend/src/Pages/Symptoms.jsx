  ...
  return (
    <React.Fragment>
      ...
      <div style={{ margin: "3% 5% 5% 5%", color: "#757575" }}>
        ...
        <p>
          In some cases, a lump may be too small for you to feel or to cause any
          unusual changes you can notice on your own. Often, an abnormal area
          turns up on a screening mammogram (X-ray of the breast), which leads
          to further testing.
        </p>
        <p>
          In other cases, however, the first sign of breast cancer is a new lump
          or mass in the breast that you or your doctor can feel. A lump that is
          painless, hard, and has uneven edges is more likely to be cancer. But
      ...
      <div style={{ margin: "5% ", color: "#757575" }}>
        ...
        <p>
          ...
          and you should visit your doctor if you experience breast changes. If
          you're over 40 or at a high risk of breast cancer, you should also
